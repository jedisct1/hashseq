...
/*
 * This BLAKE2S implementation is just here as a bonus.
 * 
 * It is not used by HashSeq, but can be useful to compute
 * an authentication code once a client has passed a challenge.
 */
